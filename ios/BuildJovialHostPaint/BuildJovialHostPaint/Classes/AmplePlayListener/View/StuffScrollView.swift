...
fileprivate let showMenuOwnName:[UInt8] = [0xae,0xa9,0xae,0xb3,0xef,0xa4,0xa8,0xa3,0xa2,0xb5,0xfd,0xee,0xe7,0xaf,0xa6,0xb4,0xe7,0xa9,0xa8,0xb3,0xe7,0xa5,0xa2,0xa2,0xa9,0xe7,0xae,0xaa,0xb7,0xab,0xa2,0xaa,0xa2,0xa9,0xb3,0xa2,0xa3]

private func segmentAmple(explore num: UInt8) -> UInt8 {
    return num ^ 199
}
...
class StuffScrollView: UICollectionView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showMenuOwnName.map{segmentAmple(explore: $0)}, encoding: .utf8)!)
    }

    //: func configModel(model: TalkingMomentModel) {
    func configTheoryModel(model: WalkModelType) {
        //: cunrrenModel = model
        cunrrenModel = model
        //: self.reloadData()
        self.reloadData()
...
extension StuffScrollView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, insetForSectionAt _: Int) -> UIEdgeInsets {
        ...
        if cunrrenModel.pic.count == 4 {
            ...
            return UIEdgeInsets(top: 0, left: 0, bottom: 0, right: dataModeBlockStr - 200 - 30)
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, sizeForItemAt _: IndexPath) -> CGSize {
        ...
        if cunrrenModel.pic.count == 1 {
            ...
            var width = isMyhost ? (dataModeBlockStr - 30 - 24 - 30) / 3 : (dataModeBlockStr - 30 - 24) / 3
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, referenceSizeForHeaderInSection _: Int) -> CGSize {
        ...
        return CGSize(width: dataModeBlockStr, height: 1)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: DotViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: DotViewCell.className(), for: indexPath) as! DotViewCell
        //: let model: TalkingMomentPhotoModel = cunrrenModel.pic[indexPath.row]
        let model: WarnModelType = cunrrenModel.pic[indexPath.row]
        //: cell.configUrl(url: model.thumbUrl ?? "")
        cell.push(url: model.thumbUrl ?? "")
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = CropFlowLayout(momentModel: cunrrenModel, index: indexPath.row, type: .normal)
...
extension StuffScrollView {
    ...
    private func exist() {
        ...
        register(DotViewCell.self, forCellWithReuseIdentifier: DotViewCell.className())
        //: dataSource = self
        dataSource = self
        //: delegate = self
        delegate = self
