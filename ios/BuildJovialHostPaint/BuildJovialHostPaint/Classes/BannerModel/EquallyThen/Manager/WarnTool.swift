...
extension WarnTool {
    ...
    func piece(_ frontCamera: Bool) {
        ...
        self.replaceFront(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func ply(_ openCamera: Bool) {
        ...
        self.progress(isOpen: openCamera)
    }
    ...
    func doingdView() {
        ...
        DispatchQueue.main.async {
            ...
            self.customerWindow(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension WarnTool {
    ...
    private func replaceFront(front: Bool) {
    ...
    private func progress(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard data_progressName == true else {
            //: if isOpen {
            if isOpen {
...
extension WarnTool {
    ...
    func andShade() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(successDownMp(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(managerExecute(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(animalForm(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(audioTwo(notif:)),
    ...
    @objc private func successDownMp(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func managerExecute(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func animalForm(notif: Notification) {
    ...
    @objc func audioTwo(notif: Notification) {
...
extension WarnTool {
    ...
    func suite() {
        ...
        if self.infoModel?.videoStage == .Waiting {
            ...
            customerWindow(smallWindow: false)
        ...
        //: } else if self.infoModel?.videoStage == .Calling {
            ...
            //: } else {
                ...
                customerWindow(smallWindow: true)
            }
        }
    ...
    func customerWindow(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard data_progressName == true else {
