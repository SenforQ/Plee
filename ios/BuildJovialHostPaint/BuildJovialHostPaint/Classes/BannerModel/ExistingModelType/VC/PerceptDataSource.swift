...
/*: "Search" :*/
fileprivate let notiModelData:[Character] = ["S","e","a","r","c","h"]

/*: "#F5F5F5" :*/
fileprivate let noti_bothFieldValue:String = "magnitude reserve early maximum#F5F5F5"

/*: "Search by UID" :*/
fileprivate let userBrightTitle:String = "psychological past template perceptSear"
fileprivate let userRegionTagFocusId:String = "id"

/*: "icon_search_sea" :*/
fileprivate let app_takeFrontAdditionName:String = "icohighlight"
fileprivate let constForeData:String = "decide priority program broadcast leftrch_"
fileprivate let notiManName:String = "serounding"

/*: "Can’t find~" :*/
fileprivate let kBeforeCookFormat:String = "Can\u{2019}t fin"
fileprivate let const_solarUrl:String = "d~sh nose straight which successfully"

/*: "icon_kong_kong_default" :*/
fileprivate let kHereHappyDirectionMsg:[Character] = ["i","c","o","n","_","k","o","n","g","_","k","o","n","g","_","d","e","f","a","u","l","t"]

/*: "Please enter the query UID" :*/
fileprivate let constContrastValue:[Character] = ["P","l","e","a","s","e"," ","e","n","t","e","r"," ","t","h","e"," ","q","u","e","r"]
fileprivate let kElementMessage:[Character] = ["y"," ","U","I","D"]
...
class PerceptDataSource: OperateReactiveCompatible {
    ...
    private lazy var searchBtn: UIButton = {
        ...
        btn.setTitle((String(notiModelData)).localized, for: .normal)
        ...
        btn.setBackgroundImage(UIImage.thumbNumbererest(colors: UIColor.ratingConfirm(), size: CGSize(width: 72, height: 32)), for: .normal)
        //: btn.layer.cornerRadius = 16
        btn.layer.cornerRadius = 16
        //: btn.clipsToBounds = true
        btn.clipsToBounds = true
        //: btn.addTarget(self, action: #selector(searchButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(procure), for: .touchUpInside)
        //: btn.alpha = 0.5
        btn.alpha = 0.5
    ...
    private lazy var searchTF: UITextField = {
        ...
        tf.placeholder = (String(userBrightTitle.suffix(4)) + "ch by U" + userRegionTagFocusId.uppercased()).localized
    ...
    private lazy var unlessEditingView: UIView = {
        ...
        let image = UIImage.adjust(name: (app_takeFrontAdditionName.replacingOccurrences(of: "highlight", with: "n") + "_sea" + String(constForeData.suffix(4)) + notiManName.replacingOccurrences(of: "rounding", with: "a")))
    ...
    private lazy var tableView: UITableView = {
        ...
        tabV.register(WrongReactiveCompatible.self, forCellReuseIdentifier: WrongReactiveCompatible.className())
    ...
    private lazy var emptyV: EmptyView = {
        ...
        style.TipsTitle = (kBeforeCookFormat + String(const_solarUrl.prefix(2))).localized
        //: style.TipsIcon = "icon_kong_kong_default"
        style.TipsIcon = (String(kHereHappyDirectionMsg))
        ...
        let v = EmptyView(frame: CGRect(x: 0, y: 14 + show_needMessage, width: dataModeBlockStr, height: constCornerDetailUrl - (14 + show_needMessage + mainEnterStr)), style: style)
    ...
    private lazy var reqManager: GrindSearchManager = //: return GrindSearchManager()
        .init()
    //: }()
}
...
extension PerceptDataSource {
    ...
    private func latinizeUid() {
        ...
        reqManager.outOfSight(uid: searchTF.text ?? "") { [weak self] _, _, _ in
            //: ProgressHUD.dismiss()
...
extension PerceptDataSource: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: WrongReactiveCompatible.className(), for: indexPath) as! WrongReactiveCompatible
        //: let model = reqManager.searchListDataArr[indexPath.row]
        let model = reqManager.searchListDataArr[indexPath.row]
        //: cell.refreshCell(model: model)
        cell.computerSimulation(model: model)
...
extension PerceptDataSource: UITextFieldDelegate {
...
extension PerceptDataSource: JXPagingViewListViewDelegate {
...
extension PerceptDataSource {
    ...
    private func femaleRedSubviews() {
