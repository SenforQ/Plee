...
fileprivate let user_insideYouName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "JXBannerCellID" :*/
fileprivate let appShadeMsg:[Character] = ["J","X","B","a","n","n","e","r","C","e","l","l","I","D"]
...
class ScoreWorkerThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_insideYouName.reversed(), encoding: .utf8)!)
    }
...
extension ScoreWorkerThen: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(appShadeMsg)))
    }
...
extension ScoreWorkerThen {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func joinData(bannerData: [BannerModel]) {
...
extension ScoreWorkerThen {
    ...
    private func betweenHiddenPriority() {
