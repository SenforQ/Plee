...
public struct Config {
    ...
    public static var initialMenuStyle: RunningMenuStyle?

    
    //: public struct MenuCellConfig {        
    public struct OutsideTransition {        
    ...
    public struct ScoreGravityMulti {
