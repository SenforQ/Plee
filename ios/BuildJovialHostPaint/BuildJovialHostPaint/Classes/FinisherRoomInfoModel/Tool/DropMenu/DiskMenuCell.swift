...
fileprivate let main_topicName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class DiskMenuCell: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.exaggerateElementParadigm()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.electronicEquipmentSpeaker()
    ...
    var menuModel: AttentionMenuModel? {
        //: didSet {
        didSet {
    ...
    var dropMenuStyle: RunningMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_topicName.reversed(), encoding: .utf8)!)
    }
    ...
    private func exaggerateElementParadigm() -> UIImageView {
    ...
    private func electronicEquipmentSpeaker() -> UILabel {
    ...
    private func availableAttribute() {
        //: let lineLayer = CAShapeLayer()
        let lineLayer = CAShapeLayer()
        //: lineLayer.strokeColor = UIColor.RGBA(230, 230, 230, 1.0).cgColor
        lineLayer.strokeColor = UIColor.restate(230, 230, 230, 1.0).cgColor
