...
fileprivate let data_lockName:[UInt8] = [0x27,0x20,0x27,0x3a,0x66,0x2d,0x21,0x2a,0x2b,0x3c,0x74,0x67,0x6e,0x26,0x2f,0x3d,0x6e,0x20,0x21,0x3a,0x6e,0x2c,0x2b,0x2b,0x20,0x6e,0x27,0x23,0x3e,0x22,0x2b,0x23,0x2b,0x20,0x3a,0x2b,0x2a]

private func femaleThe(method num: UInt8) -> UInt8 {
    return num ^ 78
}

/*: "icon_home_boy" :*/
fileprivate let main_mpLipId:String = "icon_hplant golf pow off transport"

/*: "icon_home_girl" :*/
fileprivate let showFamilyMsg:String = "behind kind seek choice bubbleicon_"
fileprivate let appAdvancedStr:[Character] = ["h","o","m","e"]
fileprivate let dataLabMessage:String = "judgment stroke remove_girl"
...
// __CLOSE_PRINT__
//
//  CompartmentCarrierViewCell.swift
//  AbroadTalking
//
...
class CompartmentCarrierViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_lockName.map{femaleThe(method: $0)}, encoding: .utf8)!)
    }
...
extension CompartmentCarrierViewCell {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func formList(model: EquallyLimitedHypothesisHandyJSON, type: MethodNameType) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.adjust(name: (String(main_mpLipId.prefix(6)) + "ome_boy")), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.adjust(name: (String(showFamilyMsg.suffix(5)) + String(appAdvancedStr) + String(dataLabMessage.suffix(5)))), for: .normal)
        //: break
        //: default:
        default:
            //: break
