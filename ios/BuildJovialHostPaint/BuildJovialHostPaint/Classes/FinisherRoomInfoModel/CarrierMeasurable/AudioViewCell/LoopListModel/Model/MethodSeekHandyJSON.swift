...
@objcMembers class MethodSeekHandyJSON: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: LevelMultiReactiveCompatible?
    //: var gift: TalkingMsgGiftModel?
    var gift: MiddleEntryThen?
    //: var user: TalkingMsgUserModel?
    var user: UserModel?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: PinAnyoneHandyJSON?
...
class LevelMultiReactiveCompatible: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class PinAnyoneHandyJSON: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class MiddleEntryThen: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
