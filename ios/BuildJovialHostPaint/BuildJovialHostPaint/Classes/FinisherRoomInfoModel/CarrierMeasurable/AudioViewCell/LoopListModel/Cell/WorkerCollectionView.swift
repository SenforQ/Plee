...
fileprivate let show_additionalCarryId:[UInt8] = [0xf4,0xf9,0xf4,0xff,0xb3,0xee,0xfa,0xef,0xf0,0xfd,0xc5,0xb4,0xab,0xf3,0xec,0xfe,0xab,0xf9,0xfa,0xff,0xab,0xed,0xf0,0xf0,0xf9,0xab,0xf4,0xf8,0xfb,0xf7,0xf0,0xf8,0xf0,0xf9,0xff,0xf0,0xef]

fileprivate func ittyBitty(name num: UInt8) -> UInt8 {
...
class WorkerCollectionView: FamilySeekCompartmentMsgCell {
    //: var giftData: GeneralCellData?
    var giftData: GeneralCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_additionalCarryId.map{ittyBitty(name: $0)}, encoding: .utf8)!)
    }
