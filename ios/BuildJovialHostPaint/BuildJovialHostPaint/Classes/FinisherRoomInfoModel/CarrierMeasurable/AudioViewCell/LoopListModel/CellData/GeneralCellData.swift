...
fileprivate let const_accelerateName:[UInt8] = [0xfd,0xfa,0xfd,0xe0,0xbc,0xf7,0xfb,0xf0,0xf1,0xe6,0xae,0xbd,0xb4,0xfc,0xf5,0xe7,0xb4,0xfa,0xfb,0xe0,0xb4,0xf6,0xf1,0xf1,0xfa,0xb4,0xfd,0xf9,0xe4,0xf8,0xf1,0xf9,0xf1,0xfa,0xe0,0xf1,0xf0]

private func randomPortrait(security num: UInt8) -> UInt8 {
    return num ^ 148
}

/*: "Open lucky blind-box\nSent " :*/
fileprivate let kAcquireCurveKey:[Character] = ["O","p","e","n"," ","l","u","c","k","y"]
fileprivate let constStreamMessage:String = "child connect adjust meet blin"
fileprivate let appRankMessage:String = "Sent step television self destroy"

/*: "Sent " :*/
fileprivate let data_shadowText:[Character] = ["S","e","n","t"," "]

/*: "#FFEE4B" :*/
fileprivate let notiCoreKey:[Character] = ["#","F","F","E","E","4","B"]
...
//: @objcMembers public class GeneralCellData: TalkingChatMsgBaseCellData {
@objcMembers public class GeneralCellData: PinReactiveCompatible {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_accelerateName.map{randomPortrait(security: $0)}, encoding: .utf8)!)
    }

    //: public override func contentSize() -> CGSize {
    override public func conceal() -> CGSize {
        //: let maxWidth = ScreenWidth - (25 + self.cellLayout.avatarSize.width) * 2 - 22 - 80
        let maxWidth = dataModeBlockStr - (25 + self.cellLayout.avatarSize.width) * 2 - 22 - 80
    ...
    public lazy var attributedString: NSMutableAttributedString = {
        ...
        let attr = opFreebee(giftModel: self.msgModel.gift)
        //: return attr
        return attr
        //: }()
    }()
    ...
    func opFreebee(giftModel: DigModel) -> NSMutableAttributedString {
        ...
        if giftModel.showType == "\(TranslateInsetTarget.myStery.rawValue)" {
            ...
            attr1 = NSMutableAttributedString(string: (String(kAcquireCurveKey) + String(constStreamMessage.suffix(5)) + "d-box\n" + String(appRankMessage.prefix(5))).localized, attributes: [.font: font, .foregroundColor: color])
            //: }else {
        } else {
            //: attr1 = NSMutableAttributedString.init(string: "Sent ".localized, attributes: [.font: font, .foregroundColor: color])
            attr1 = NSMutableAttributedString(string: (String(data_shadowText)).localized, attributes: [.font: font, .foregroundColor: color])
        }
        ...
        let color2 = (self.direction == .MsgDirectionOutgoing ? UIColor(hex: (String(notiCoreKey))) : UIColor.labIndicator())
    ...
    private func fore(giftmodel: DigModel) -> String {
        ...
        if CoverAddrTool.share.interfaceLang == CurrencyTableConvertible.en.rawValue {
            ...
            gameName = giftmodel.nameI18n[CurrencyTableConvertible.en.rawValue] as? String ?? ""
            ...
            gameName = giftmodel.nameI18n[CurrencyTableConvertible.ar.rawValue] as? String ?? ""
            ...
            gameName = giftmodel.nameI18n[CurrencyTableConvertible.es.rawValue] as? String ?? ""
            ...
            gameName = giftmodel.nameI18n[CurrencyTableConvertible.pt.rawValue] as? String ?? ""
        }
        //: return gameName
        return gameName
    }
