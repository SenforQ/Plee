...
/*: ".png" :*/
fileprivate let dataRowId:[Character] = [".","p","n","g"]
...
// __CLOSE_PRINT__
//
//  ManufacturerGraphReactiveCompatible.swift
//  AbroadTalking
//
...
//: @objcMembers public class ManufacturerGraphReactiveCompatible: TalkingChatMsgBaseCellData {
@objcMembers public class ManufacturerGraphReactiveCompatible: PinReactiveCompatible {
    ...
    override public var msgModel: ProLipModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.romaineLettuce(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func joinAcross(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(mainEnabledStr)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + RealmReactiveCompatible.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + RealmReactiveCompatible.share.loginUserMode.userID + (String(dataRowId))
        ...
        let imageData = UIImage.responseCommit(image, row: 2 * 1024)
