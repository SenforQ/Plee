...
@interface AnteriorModel : JSONModel
...
@property (nonatomic, strong) AppearanceModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) SessionModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) TitlelessModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) MeetingModel *wantGift; /// 想要礼物
...
@interface AppearanceModel : JSONModel
...
@interface TitlelessModel: JSONModel
...
@interface DistantModel : JSONModel
...
@interface VerticalAnalogDigitalConverterModel : JSONModel
...
@interface WitnesserModel : JSONModel
...
@property (nonatomic, strong) FacilityModel *renderData;
...
@interface FacilityModel : JSONModel
