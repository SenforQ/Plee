...
@objc public enum AirExpressionConvertible: UInt {
...
@objc public enum TransitionHashable: UInt {
 ...
 */
//: @objcMembers public class EveryBitThen: TCommonCellData {
@objcMembers public class EveryBitThen: ThanksNoCellData {
    ...
    public var direction: TransitionHashable = .MsgDirectionIncoming
    ...
    public var translateStatus: AirExpressionConvertible = .MsgTranslate_init
    ...
    public var msgModel: ProLipModel = ProLipModel()
    ...
    public var cellLayout: MultiReactiveCompatible!
    ...
    public init(direction: TransitionHashable) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.writerExWho()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = MultiReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = MultiReactiveCompatible(isIncomming: false)
    ...
    public override func width(_ width: CGFloat) -> CGFloat {
