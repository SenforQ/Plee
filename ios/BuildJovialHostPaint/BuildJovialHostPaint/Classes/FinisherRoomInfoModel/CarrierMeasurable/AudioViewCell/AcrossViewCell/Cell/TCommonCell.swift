...
@objcMembers public class ThanksNoCellData: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func width(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class ScoreViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: ThanksNoCellData?
    ...
    @objc dynamic public func beyondDestroy(with data: ThanksNoCellData) {
        //: self.data = data
        self.data = data
    }
} 