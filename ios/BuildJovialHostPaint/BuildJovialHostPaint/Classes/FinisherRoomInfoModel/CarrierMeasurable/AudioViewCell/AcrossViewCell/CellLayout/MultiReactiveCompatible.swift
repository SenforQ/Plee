...
@objcMembers public class MultiReactiveCompatible: NSObject {
    ...
    class func mongrel() -> MultiReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = MultiReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func tagPurchase() -> MultiReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = MultiReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func less() -> MultiReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = MultiReactiveCompatible.init(isIncomming: false)
    ...
    class func frontLayout() -> MultiReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = MultiReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func list() -> MultiReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = MultiReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
