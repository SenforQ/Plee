...
fileprivate let notiCreateRobotName:[UInt8] = [0xa9,0xae,0xa9,0xb4,0xe8,0xa3,0xaf,0xa4,0xa5,0xb2,0xfa,0xe9,0xe0,0xa8,0xa1,0xb3,0xe0,0xae,0xaf,0xb4,0xe0,0xa2,0xa5,0xa5,0xae,0xe0,0xa9,0xad,0xb0,0xac,0xa5,0xad,0xa5,0xae,0xb4,0xa5,0xa4]

private func publishBound(write num: UInt8) -> UInt8 {
    return num ^ 192
}

/*: "#F5F5F5" :*/
fileprivate let app_theRewardKey:String = "maybe technical container direction#F5F5"
fileprivate let kEditorKey:String = "weight5"

/*: "level_ :*/
fileprivate let k_railData:[Character] = ["l","e","v","e","l","_"]
...
class RecordThen: UITableViewCell {
    //: var currenModel = TalkingLiveRoomOnlineListModel()
    var currenModel = RepresentModelType()
    //: var index = 0
    var index = 0
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiCreateRobotName.map{publishBound(write: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var lineView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(app_theRewardKey.suffix(5)) + kEditorKey.replacingOccurrences(of: "weight", with: "F")))
        //: return view
        return view
        //: }()
    }()
...
extension RecordThen {
    ...
    func oldTelephone(model: RepresentModelType, index: Int) {
        //: currenModel = model
        currenModel = model
        //: self.index = index
        self.index = index
        ...
        IconImg.noneAdvancedFinish(urlStr: model.headPic)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: levelIcon.image = UIImage.BundleImageNamed(name: "level_\(model.level )")
        levelIcon.image = UIImage.adjust(name: (String(k_railData)) + "\(model.level)")
    }
}
