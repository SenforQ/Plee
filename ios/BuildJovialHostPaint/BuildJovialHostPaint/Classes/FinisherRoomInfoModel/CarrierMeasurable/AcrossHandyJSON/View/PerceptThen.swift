...
fileprivate let userTogetherData:[UInt8] = [0x1b,0x1c,0x1b,0x6,0x5a,0x11,0x1d,0x16,0x17,0x0,0x48,0x5b,0x52,0x1a,0x13,0x1,0x52,0x1c,0x1d,0x6,0x52,0x10,0x17,0x17,0x1c,0x52,0x1b,0x1f,0x2,0x1e,0x17,0x1f,0x17,0x1c,0x6,0x17,0x16]

private func padSoul(twin num: UInt8) -> UInt8 {
    return num ^ 114
}

/*: "icon_tc_warn" :*/
fileprivate let show_feeText:String = "bottom stretchicon_t"

/*: "Live Warning" :*/
fileprivate let constPeopleMessage:[Character] = ["L","i","v","e"," ","W","a","r","n"]
fileprivate let const_combinePath:String = "plantg"

/*: "Violation Reason: " :*/
fileprivate let dataClickBeUrl:[Character] = ["V","i","o","l","a","t","i","o","n"," ","R","e","a","s","o"]
fileprivate let constBeatResignMsg:[Character] = ["n",":"," "]

/*: "Warning Time: " :*/
fileprivate let app_robotUrl:String = "detail bass into surgery branchWa"
fileprivate let show_signatureText:String = "rbounceibounce"
...
class PerceptThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userTogetherData.map{padSoul(twin: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.adjust(name: (String(show_feeText.suffix(6)) + "c_warn"))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.font = UIFont.shrinkSize(type: .Semibold, fontSize: 18)
        //: lab.textAlignment = .center
        lab.textAlignment = .center
        //: lab.text = "Live Warning".localized
        lab.text = (String(constPeopleMessage) + const_combinePath.replacingOccurrences(of: "plant", with: "in")).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(resistanceDismiss), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension PerceptThen {
    ...
    func thanFeed(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.labIndicator()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(dataClickBeUrl) + String(constBeatResignMsg)).localized
        ...
        var timeText = (String(app_robotUrl.suffix(2)) + show_signatureText.replacingOccurrences(of: "bounce", with: "n") + "g Time: ").localized
