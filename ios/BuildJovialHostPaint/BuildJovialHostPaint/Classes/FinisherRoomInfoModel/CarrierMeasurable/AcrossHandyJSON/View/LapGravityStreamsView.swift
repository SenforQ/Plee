...
fileprivate let mainFoundWindowData:[UInt8] = [0x28,0x2f,0x28,0x35,0x69,0x22,0x2e,0x25,0x24,0x33,0x7b,0x68,0x61,0x29,0x20,0x32,0x61,0x2f,0x2e,0x35,0x61,0x23,0x24,0x24,0x2f,0x61,0x28,0x2c,0x31,0x2d,0x24,0x2c,0x24,0x2f,0x35,0x24,0x25]

private func unitedStatesOfAmerica(down num: UInt8) -> UInt8 {
    return num ^ 65
}
...
class LapGravityStreamsView: AmpleThen {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainFoundWindowData.map{unitedStatesOfAmerica(down: $0)}, encoding: .utf8)!)
    }
...
extension LapGravityStreamsView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func doinglyUrl(liveUrl: String) {
...
extension LapGravityStreamsView: TXLivePlayListener {
