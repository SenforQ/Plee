...
fileprivate let user_distributionName:[UInt8] = [0xe,0x9,0xe,0x13,0x4f,0x4,0x8,0x3,0x2,0x15,0x5d,0x4e,0x47,0xf,0x6,0x14,0x47,0x9,0x8,0x13,0x47,0x5,0x2,0x2,0x9,0x47,0xe,0xa,0x17,0xb,0x2,0xa,0x2,0x9,0x13,0x2,0x3]

private func computeMonth(exposure num: UInt8) -> UInt8 {
    return num ^ 103
}

/*: "#E6BD8B" :*/
fileprivate let userWomanName:[Character] = ["#","E","6","B","D","8","B"]

/*: "get json error" :*/
fileprivate let const_justKey:[Character] = ["g","e","t"," ","j","s","o","n"," ","e","r","r","o","r"]
...
// __CLOSE_PRINT__
//
//  PrevalenceReactiveCompatible.swift
//  AbroadTalking
//
...
class PrevalenceReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_distributionName.map{computeMonth(exposure: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.shrinkSize(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (String(userWomanName)))
...
extension PrevalenceReactiveCompatible {
    //: func setPointData(point: String, isminiStr: Bool = false) {
    func fundamental(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(userWomanName)))!, .font: UIFont.shrinkSize(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (String(userWomanName)))!, .font: UIFont.shrinkSize(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = PortraitJackEffectTool.default.responsibility(type: .VideoCall_femalePoint)
            ...
            if CoverAddrTool.share.interfaceLang == CurrencyTableConvertible.ar.rawValue {
                ...
                url = PortraitJackEffectTool.default.responsibility(type: .videoCall_femalePoint_ar)
                ...
                url = PortraitJackEffectTool.default.responsibility(type: .videoCall_femalePoint_es)
                ...
                url = PortraitJackEffectTool.default.responsibility(type: .videoCall_femalePoint_pt)
            }
            ...
            printLog(message: (String(const_justKey)))
        }
    }
}
