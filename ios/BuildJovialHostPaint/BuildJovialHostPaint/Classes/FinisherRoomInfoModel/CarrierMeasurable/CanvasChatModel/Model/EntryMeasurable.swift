...
let user_changeScaleContent = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let userSessionStr = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let noti_replaceMomentValue = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct EntryMeasurable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
