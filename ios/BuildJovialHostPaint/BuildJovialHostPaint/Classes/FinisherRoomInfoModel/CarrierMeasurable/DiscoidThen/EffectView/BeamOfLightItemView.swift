...
fileprivate let user_psychologicalName:[UInt8] = [0xe5,0xea,0xe5,0xf0,0xa4,0xdf,0xeb,0xe0,0xe1,0xee,0xb6,0xa5,0x9c,0xe4,0xdd,0xef,0x9c,0xea,0xeb,0xf0,0x9c,0xde,0xe1,0xe1,0xea,0x9c,0xe5,0xe9,0xec,0xe8,0xe1,0xe9,0xe1,0xea,0xf0,0xe1,0xe0]

fileprivate func destinationCapabilityHome(good num: UInt8) -> UInt8 {
...
class BeamOfLightItemView: ObjectItemView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_psychologicalName.map{destinationCapabilityHome(good: $0)}, encoding: .utf8)!)
    }
    ...
    override func endMaximum() {
        ...
        let filePath = EquallyRemainThen.shared.buryModel(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.cost(effectItemView: self, success: true)
    ...
    override func scruple() {
        //: aPlayer.pauseAnimation()
        aPlayer.pauseAnimation()
    }

    //: override func resumeAnimation() -> Bool {
    override func resumeWithAnimation() -> Bool {
        //: return true
        return true
    }
...
extension BeamOfLightItemView: SVGAPlayerDelegate {
