...
open class ImmobiliseScrollView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = ImmobiliseScrollView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func changeAndLabelStep() {
