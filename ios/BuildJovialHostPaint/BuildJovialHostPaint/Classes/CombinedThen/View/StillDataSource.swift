...
fileprivate let notiAssignTailPath:[UInt8] = [0x53,0x58,0x53,0x5e,0x12,0x4d,0x59,0x4e,0x4f,0x5c,0x24,0x13,0xa,0x52,0x4b,0x5d,0xa,0x58,0x59,0x5e,0xa,0x4c,0x4f,0x4f,0x58,0xa,0x53,0x57,0x5a,0x56,0x4f,0x57,0x4f,0x58,0x5e,0x4f,0x4e]

fileprivate func sheetGlass(lock num: UInt8) -> UInt8 {
...
typealias DeleteTagBlock = (SoulTagModel) -> Void

//: class TalkingTagView: UIView {
class StillDataSource: UIView {
    //: var deleteBlock: DeleteTagBlock!
    var deleteBlock: DeleteTagBlock!
    //: var titles = [UserSeleteTagModel]()
    var titles = [SoulTagModel]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiAssignTailPath.map{sheetGlass(lock: $0)}, encoding: .utf8)!)
    }
...
extension StillDataSource: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension StillDataSource: GreatLayoutDelegate {
...
extension StillDataSource {
    //: func setframe(frame: CGRect) {
    func turnDown(frame _: CGRect) {
