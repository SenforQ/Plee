...
fileprivate let show_okRejectText:[UInt8] = [0xce,0xc9,0xce,0xd3,0x8f,0xc4,0xc8,0xc3,0xc2,0xd5,0x9d,0x8e,0x87,0xcf,0xc6,0xd4,0x87,0xc9,0xc8,0xd3,0x87,0xc5,0xc2,0xc2,0xc9,0x87,0xce,0xca,0xd7,0xcb,0xc2,0xca,0xc2,0xc9,0xd3,0xc2,0xc3]

private func effValue(you num: UInt8) -> UInt8 {
    return num ^ 167
}

/*: "bth_me_chat_nor" :*/
fileprivate let notiMovieKey:[Character] = ["b","t","h","_","m","e","_"]
fileprivate let constTitleData:String = "read"
fileprivate let noti_orientationPath:[Character] = ["a","t","_","n","o","r"]

/*: "#6ADEFF" :*/
fileprivate let noti_discourseName:String = "rank illegal#6ADEFF"

/*: "#5D6FFF" :*/
fileprivate let appFlagValue:String = "shrink little average#5D6FFF"

/*: "icon_lounge" :*/
fileprivate let dataFundamentalMessage:String = "icoserve"
fileprivate let app_ninePrimeKey:String = "ghour"

/*: "icon_video_call" :*/
fileprivate let kClickCustomMsg:[Character] = ["i","c","o","n","_","v","i","d","e","o","_"]
fileprivate let user_detailedKey:String = "cadistribution"

/*: "iv_me_vip" :*/
fileprivate let showHairMessage:String = "iv_mport numb volume re"

/*: "Edit" :*/
fileprivate let show_numbId:[Character] = ["E","d","i","t"]

/*: "icon_Chat_freetimes" :*/
fileprivate let userDesignName:String = "score stretchicon_C"
fileprivate let app_magneticStrokeData:String = "rdueduetimdues"

/*: "#AB57F6" :*/
fileprivate let showBarMessage:[Character] = ["#","A","B","5","7","F","6"]

/*: "#FC57B7" :*/
fileprivate let const_columnStr:[Character] = ["#","F","C","5","7","B","7"]

/*: "#FE9074" :*/
fileprivate let userPrepareKey:String = "slide excitement aircraft screen#FE907"
fileprivate let notiWholePath:String = "4"

/*: "Video Call" :*/
fileprivate let user_wantValue:String = "Videoshine theory copy cookie"
fileprivate let userChannelSingleMsg:[Character] = [" ","C","a","l","l"]
...
// __CLOSE_PRINT__
//
//  AssureReactiveCompatible.swift
//  AbroadTalking
//
...
let kGreetData = (15 + actualWidth(w: 36) + 15 + user_bottomDailyKey)

//: class TalkingUserDetailBottomView: UIView {
class AssureReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_okRejectText.map{effValue(you: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var shadowLayer: CAGradientLayer = {
        ...
        layer.frame = CGRect(x: 0, y: 0, width: dataModeBlockStr, height: 15 + actualWidth(w: 38) + 15)
    ...
    private lazy var chatBtn: UIImageView = {
        ...
        img.image = UIImage.adjust(name: (String(notiMovieKey) + constTitleData.replacingOccurrences(of: "read", with: "ch") + String(noti_orientationPath)))
        //: img.isUserInteractionEnabled = true
        img.isUserInteractionEnabled = true
        //: let tap = UITapGestureRecognizer(target: self, action: #selector(chatButtonClick))
        let tap = UITapGestureRecognizer(target: self, action: #selector(guideBy))
    ...
    private lazy var videoBtn: UIButton = {
        ...
        let colors = [UIColor(hex: (String(noti_discourseName.suffix(7))))!.cgColor, UIColor(hex: (String(appFlagValue.suffix(7))))!.cgColor]
        ...
        btn.setBackgroundImage(UIImage.thumbNumbererest(colors: colors, size: CGSize(width: actualWidth(w: 250), height: actualWidth(w: 36))), for: .normal)
    ...
    private lazy var vipIcon: UIImageView = {
        ...
        img.image = UIImage.adjust(name: (dataFundamentalMessage.replacingOccurrences(of: "serve", with: "n") + "_loun" + app_ninePrimeKey.replacingOccurrences(of: "hour", with: "e")))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var callIcon: UIImageView = {
        ...
        img.image = UIImage.adjust(name: (String(kClickCustomMsg) + user_detailedKey.replacingOccurrences(of: "distribution", with: "ll")))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var maleVipPriceBtn: UIImageView = {
        ...
        img.image = UIImage.adjust(name: (String(showHairMessage.prefix(4)) + "e_vip"))
        //: img.isUserInteractionEnabled = true
        img.isUserInteractionEnabled = true
    ...
    lazy var editBtn: UIButton = {
        ...
        btn.setTitle((String(show_numbId)).localized, for: .normal)
        ...
        btn.addTarget(self, action: #selector(holderClick), for: .touchUpInside)
        //: btn.isHidden = true
        btn.isHidden = true
    ...
    lazy var freeImg: UIImageView = {
        ...
        img.image = UIImage.adjust(name: (String(userDesignName.suffix(6)) + "hat_f" + app_magneticStrokeData.replacingOccurrences(of: "due", with: "e")))
        //: return img
        return img
        //: }()
    }()
...
extension AssureReactiveCompatible {
    /// 男性侧vip价格按钮点击事件
    ...
    @objc func location() {
        ...
        dataFilterFormat.psychologicalFeatureTarget(eventID: data_enterText, toUid: userInfoModel.uid)
        //: if RealmReactiveCompatible.share.loginUserMode.sex == Gender.male.rawValue {
        if RealmReactiveCompatible.share.loginUserMode.sex == FullHashable.male.rawValue { // 男性用户
            ...
            videoCallManager.evaluateMethod(videoPrice: userInfoModel.videoBean, voicePrice: userInfoModel.voiceBean, vipPrompt: userInfoModel.prompt)
        }
    }

    /// chat
    //: @objc private func chatButtonClick() {
    @objc private func guideBy() {
        //: BrowReactiveCompatible.share.func__pushToPriveteChatVC(chatID: userInfoModel.uid)
        BrowReactiveCompatible.share.minCompletion(chatID: userInfoModel.uid)
        //: uploadRecord.uploadRecordEvent(eventID: ClickProfileChatButton, toUid: userInfoModel.uid)
        dataFilterFormat.psychologicalFeatureTarget(eventID: showTableStr, toUid: userInfoModel.uid)
    }

    /// edit
    //: @objc private func editButtonClick() {
    @objc private func holderClick() {
...
extension AssureReactiveCompatible {
    ...
    func counterval(_ userModel: SeekTransformable) {
        ...
        // 根据角色 展示/隐藏 按钮
        //: if userModel.uid == RealmReactiveCompatible.share.loginUid {
        if userModel.uid == RealmReactiveCompatible.share.loginUid { // 本人资料页
            //: editBtn.isHidden = false
            editBtn.isHidden = false
            ...
            return
                    ...
                    //: } else if RealmReactiveCompatible.share.loginUid != CurrencyDefineReactiveCompatible.getCustomerServiceID(),
        } else if RealmReactiveCompatible.share.loginUid != CurrencyDefineReactiveCompatible.facilityBasic(),
                  //: RealmReactiveCompatible.share.loginUserMode.sex == userModel.sex,
                  RealmReactiveCompatible.share.loginUserMode.sex == userModel.sex,
        ...
        //: if RealmReactiveCompatible.share.loginUserMode.freeMsgTimes.count > 0 {
        if RealmReactiveCompatible.share.loginUserMode.freeMsgTimes.count > 0 {
        ...
        if RealmReactiveCompatible.share.loginUserMode.sex == FullHashable.male.rawValue {
            ...
            if RealmReactiveCompatible.share.loginUserMode.loungePlus == false { // 男性非会员
                ...
                if RealmReactiveCompatible.share.appStatus == GraphHashableRepresentation.normal.rawValue {
                    ...
                    maleVipPriceLab.text = String.maleVisitor(videoPrice: userInfoModel.videoVIPPrice)
                }
                //: vipIcon.isHidden = true
                vipIcon.isHidden = true
                //: callStrLab.text = String.getMaleVIPVideoPriceString(videoPrice: userInfoModel.videoPrice)
                callStrLab.text = String.maleVisitor(videoPrice: userInfoModel.videoPrice)

                //: } else {
            } else {
                //: let colors = [UIColor(hex: "#AB57F6")!.cgColor, UIColor(hex: "#FC57B7")!.cgColor, UIColor(hex: "#FE9074")!.cgColor]
                let colors = [UIColor(hex: (String(showBarMessage)))!.cgColor, UIColor(hex: (String(const_columnStr)))!.cgColor, UIColor(hex: (String(userPrepareKey.suffix(6)) + notiWholePath.capitalized))!.cgColor]
                ...
                videoBtn.setBackgroundImage(UIImage.thumbNumbererest(colors: colors, size: CGSize(width: actualWidth(w: 250), height: actualWidth(w: 36))), for: .normal)
                ...
                callStrLab.text = String.maleVisitor(videoPrice: userInfoModel.videoVIPPrice)
            }
            ...
            callStrLab.text = (String(user_wantValue.prefix(5)) + String(userChannelSingleMsg)).localized
        }
    }

    /// 添加视图
    //: private func setupSubviews() {
    private func methodHighlight() {
    ...
    private func plus() {
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(user_bottomDailyKey)
        }
    }
}
