...
fileprivate let kHornId:[UInt8] = [0xe9,0xee,0xe9,0xf4,0xa8,0xe3,0xef,0xe4,0xe5,0xf2,0xba,0xa9,0xa0,0xe8,0xe1,0xf3,0xa0,0xee,0xef,0xf4,0xa0,0xe2,0xe5,0xe5,0xee,0xa0,0xe9,0xed,0xf0,0xec,0xe5,0xed,0xe5,0xee,0xf4,0xe5,0xe4]

private func faceAngle(tot num: UInt8) -> UInt8 {
    return num ^ 128
}

/*: "btn_me_edit" :*/
fileprivate let data_satisfyMessage:String = "auto sendbtn_me_"
fileprivate let constObjectId:String = "eassertt"

/*: "Add" :*/
fileprivate let kApplyOddMaxValue:[Character] = ["A","d","d"]
...
class RemainTableCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kHornId.map{faceAngle(tot: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.adjust(name: (String(data_satisfyMessage.suffix(7)) + constObjectId.replacingOccurrences(of: "assert", with: "di"))))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.text = (String(kApplyOddMaxValue)).localized
        //: lb.isHidden = true
        lb.isHidden = true
        //: return lb
        return lb
