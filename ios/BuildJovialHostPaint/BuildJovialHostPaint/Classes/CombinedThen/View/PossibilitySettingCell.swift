...
fileprivate let constBenchMayName:[UInt8] = [0x93,0x94,0x93,0x8e,0xd2,0x99,0x95,0x9e,0x9f,0x88,0xc0,0xd3,0xda,0x92,0x9b,0x89,0xda,0x94,0x95,0x8e,0xda,0x98,0x9f,0x9f,0x94,0xda,0x93,0x97,0x8a,0x96,0x9f,0x97,0x9f,0x94,0x8e,0x9f,0x9e]

/*: "btn_me_edit" :*/
fileprivate let dataBusinessFormat:[Character] = ["b","t","n","_","m","e","_"]
fileprivate let show_seriesSurgeryText:String = "eremoteit"
...
class PossibilitySettingCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constBenchMayName.map{$0^250}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.adjust(name: (String(dataBusinessFormat) + show_seriesSurgeryText.replacingOccurrences(of: "remote", with: "d"))))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.labIndicator()
...
extension PossibilitySettingCell {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func priority(titile: String, row: Int, isLast: Bool) {
    ...
    //: func setArrows() {
    func nearVisibleArrows() {
        //: titleBLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        titleBLB.font = UIFont.shrinkSize(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.shrinkSize(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
