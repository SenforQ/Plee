...
struct SeekTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: CombinedAnyoneHandyJSON?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [WidenMeasurable]? // 相册
    ...
    var aiExtraInfo = TransitionInfoModel() // AI模型
    //: var vipSkinId = 0
...
struct WidenMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func faceSpeaker(compareTo: WidenMeasurable) -> Bool {
        //: return
        return
...
struct TransitionInfoModel: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum GalleryDotValueConvertible: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
