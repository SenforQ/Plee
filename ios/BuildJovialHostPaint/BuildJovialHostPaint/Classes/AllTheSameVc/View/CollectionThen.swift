...
fileprivate let constProductMsg:[UInt8] = [0xc5,0xc2,0xc5,0xd8,0x84,0xcf,0xc3,0xc8,0xc9,0xde,0x96,0x85,0x8c,0xc4,0xcd,0xdf,0x8c,0xc2,0xc3,0xd8,0x8c,0xce,0xc9,0xc9,0xc2,0x8c,0xc5,0xc1,0xdc,0xc0,0xc9,0xc1,0xc9,0xc2,0xd8,0xc9,0xc8]

private func frontWaitData(electronic num: UInt8) -> UInt8 {
    return num ^ 172
}

/*: "Enter phone number" :*/
fileprivate let show_tradeOrangeInformationData:[Character] = ["E","n","t","e","r"]
fileprivate let noti_upDogValue:[Character] = [" ","p","h","o","n","e"," ","n","u","m","b","e","r"]

/*: "Enter Email Address" :*/
fileprivate let appCloudMsg:String = "Enter Eclick con photo want"
fileprivate let const_levelYellowCancelId:String = "panel flagmail A"

/*: "F4F4F4" :*/
fileprivate let constConPath:[Character] = ["F","4","F","4","F","4"]

/*: "America(+1)" :*/
fileprivate let main_problemTopNextText:String = "brow front forehead joinAmeri"
fileprivate let user_rollUrl:String = "column the license plainca(+1)"

/*: "area_code_down_icon" :*/
fileprivate let constRelationFormat:String = "umber receiver judgment resume seemarea_cod"
fileprivate let show_pickId:[Character] = ["e"]
fileprivate let kPlatformBookOppositionTitle:[Character] = ["_","d","o","w","n","_","i","c","o","n"]

/*: "BBBBBB" :*/
fileprivate let data_alwaysId:String = "ignoreignoreignore"

/*: "btn_field_delete_icon" :*/
fileprivate let main_appMsg:[Character] = ["b","t","n","_","f","i","e","l","d","_","d","e","l","e","t","e"]
fileprivate let const_audienceName:[Character] = ["_","i","c","o","n"]

/*: "Password" :*/
fileprivate let notiResistanceReadyData:String = "Pasgive tape process multiple technology"
fileprivate let user_inmateUrl:[Character] = ["s","w","o","r","d"]

/*: "CCCCCC" :*/
fileprivate let constCutStr:String = "suitsuitsuitsuitsuitsuit"

/*: "F5F5F5" :*/
fileprivate let const_theId:String = "direction5direction5direction5"

/*: "Next" :*/
fileprivate let const_pushTitle:[Character] = ["N","e","x","t"]

/*: "Login by password" :*/
fileprivate let mainSaveTitle:[Character] = ["L","o","g","i","n"," ","b","y"," "]
fileprivate let main_clubCommonName:[Character] = ["p"]
fileprivate let app_foodMultiplePath:String = "assworstandard"

/*: "Login by OTP" :*/
fileprivate let mainPolicyFormat:[Character] = ["L","o","g","i","n"," ","b","y"," ","O","T","P"]

/*: "#8C7AFF" :*/
fileprivate let data_materialPath:String = "narrow cooperative column tape#8C7AFF"

/*: "Login" :*/
fileprivate let dataSoHealthyUrl:String = "Loginindex initial add title back"

/*: "Send verification" :*/
fileprivate let show_ovalMsg:String = "Sendgiving thanks"
fileprivate let k_explainFormat:String = "system"
fileprivate let mainClearExploreData:String = "catmoden"
...
class CollectionThen: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constProductMsg.map{frontWaitData(electronic: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(show_tradeOrangeInformationData) + String(noti_upDogValue)).localized : (String(appCloudMsg.prefix(7)) + String(const_levelYellowCancelId.suffix(6)) + "ddress").localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (String(constConPath)))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(main_problemTopNextText.suffix(5)) + String(user_rollUrl.suffix(6)))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.adjust(name: (String(constRelationFormat.suffix(8)) + String(show_pickId) + String(kPlatformBookOppositionTitle)))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (String(constConPath)))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.shrinkSize(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (data_alwaysId.replacingOccurrences(of: "ignore", with: "BB")))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.adjust(name: (String(main_appMsg) + String(const_audienceName))), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(notiResistanceReadyData.prefix(3)) + String(user_inmateUrl)).localized
        //: lab.textColor = .appTitleColor()
        lab.textColor = .askNameColor()
        //: lab.font = UIFont.pingfangFont(type: .Semibold, fontSize: 17)
        lab.font = UIFont.shrinkSize(type: .Semibold, fontSize: 17)
        //: lab.isHidden = true
        lab.isHidden = true
        //: return lab
        return lab
    ...
    private lazy var pwdInputView: UITextField = {
        ...
        textField.font = .shrinkSize(type: .Regular, fontSize: 17)
        //: textField.textColor = .appTitleColor()
        textField.textColor = .askNameColor()
        //: textField.layer.cornerRadius = 25
        textField.layer.cornerRadius = 25
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (constCutStr.replacingOccurrences(of: "suit", with: "C")))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (const_theId.replacingOccurrences(of: "direction", with: "F")))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(const_pushTitle)).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.labIndicator(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(mainSaveTitle) + String(main_clubCommonName) + app_foodMultiplePath.replacingOccurrences(of: "standard", with: "d")).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(mainPolicyFormat)).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(itemBroad(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(data_materialPath.suffix(7))))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension CollectionThen {
    ...
    @objc private func itemBroad(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(dataSoHealthyUrl.prefix(5))).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(const_pushTitle)).localized, for: .normal)
        }
    ...
    func bitListenerView() {
        ...
        commitButton.setTitle((String(show_ovalMsg.prefix(4)) + " verif" + k_explainFormat.replacingOccurrences(of: "system", with: "i") + mainClearExploreData.replacingOccurrences(of: "mode", with: "io")).localized, for: .normal)
    }
}
