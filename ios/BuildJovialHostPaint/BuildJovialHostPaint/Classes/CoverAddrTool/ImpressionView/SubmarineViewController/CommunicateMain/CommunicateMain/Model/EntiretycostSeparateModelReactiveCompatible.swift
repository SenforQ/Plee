...
// __CLOSE_PRINT__
//
//  EntiretycostSeparateModelReactiveCompatible.swift
//  AbroadTalking
//
...
//: @objcMembers public class EntiretycostSeparateModelReactiveCompatible: JSONModel {
@objcMembers public class EntiretycostSeparateModelReactiveCompatible: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = MainKindPriorityTarget.Face
...
//: @objc extension EntiretycostSeparateModelReactiveCompatible {
@objc extension EntiretycostSeparateModelReactiveCompatible {
    //: func initWith(suiteType: BeautyItemType)-> EntiretycostSeparateModelReactiveCompatible {
    func combineService(suiteType: MainKindPriorityTarget) -> EntiretycostSeparateModelReactiveCompatible {
        //: let model = EntiretycostSeparateModelReactiveCompatible.init()
        let model = EntiretycostSeparateModelReactiveCompatible()
