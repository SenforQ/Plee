...
typedef struct {
    Byte ostentate;
    Byte *prior;
    unsigned int serviceHand;
	int writer;
	int spill;
} StructExpandFamilyData;

@interface ExpandFamilyData : NSObject

@end

@implementation ExpandFamilyData

+ (NSData *)ExpandFamilyDataToData:(NSArray<NSNumber *> *)value {
...
+ (Byte *)ExpandFamilyDataToByte:(StructExpandFamilyData *)data {
    for (int i = 0; i < data->serviceHand; i++) {
        data->prior[i] ^= data->ostentate;
    }
    data->prior[data->serviceHand] = 0;
	if (data->serviceHand >= 2) {
		data->writer = data->prior[0];
		data->spill = data->prior[1];
	}
    return data->prior;
}

+ (NSString *)StringFromExpandFamilyData:(StructExpandFamilyData *)data {
    return [NSString stringWithUTF8String:(char *)[self ExpandFamilyDataToByte:data]];
}

//: M_SenseME_Face_Video_5.3.4
+ (NSString *)main_familyContent {
    /* static */ NSString *main_familyContent = nil;
    if (!main_familyContent) {
		NSArray<NSNumber *> *origin = @[@111, @125, @113, @71, @76, @81, @71, @111, @103, @125, @100, @67, @65, @71, @125, @116, @75, @70, @71, @77, @125, @23, @12, @17, @12, @22, @4];
		NSData *data = [ExpandFamilyData ExpandFamilyDataToData:origin];
        StructExpandFamilyData value = (StructExpandFamilyData){34, (Byte *)data.bytes, 26, 178, 230};
        main_familyContent = [self StringFromExpandFamilyData:&value];
    }
    return main_familyContent;
}

//: hasFace
+ (NSString *)app_symbolShouldUrl {
    /* static */ NSString *app_symbolShouldUrl = nil;
    if (!app_symbolShouldUrl) {
		NSArray<NSNumber *> *origin = @[@133, @140, @158, @171, @140, @142, @136, @89];
		NSData *data = [ExpandFamilyData ExpandFamilyDataToData:origin];
        StructExpandFamilyData value = (StructExpandFamilyData){237, (Byte *)data.bytes, 7, 98, 174};
        app_symbolShouldUrl = [self StringFromExpandFamilyData:&value];
    }
    return app_symbolShouldUrl;
}

//: FaceActionEvent_Interval_1_second
+ (NSString *)main_judgeBroadUrl {
    /* static */ NSString *main_judgeBroadUrl = nil;
    if (!main_judgeBroadUrl) {
		NSArray<NSNumber *> *origin = @[@10, @45, @47, @41, @13, @47, @56, @37, @35, @34, @9, @58, @41, @34, @56, @19, @5, @34, @56, @41, @62, @58, @45, @32, @19, @125, @19, @63, @41, @47, @35, @34, @40, @119];
		NSData *data = [ExpandFamilyData ExpandFamilyDataToData:origin];
        StructExpandFamilyData value = (StructExpandFamilyData){76, (Byte *)data.bytes, 33, 105, 32};
        main_judgeBroadUrl = [self StringFromExpandFamilyData:&value];
    }
    return main_judgeBroadUrl;
}

//: model
+ (NSString *)noti_spillPath {
    /* static */ NSString *noti_spillPath = nil;
    if (!noti_spillPath) {
		NSArray<NSNumber *> *origin = @[@72, @74, @65, @64, @73, @141];
		NSData *data = [ExpandFamilyData ExpandFamilyDataToData:origin];
        StructExpandFamilyData value = (StructExpandFamilyData){37, (Byte *)data.bytes, 5, 232, 34};
        noti_spillPath = [self StringFromExpandFamilyData:&value];
    }
    return noti_spillPath;
}

//: camera_focus_red
+ (NSString *)k_utilityId {
    /* static */ NSString *k_utilityId = nil;
    if (!k_utilityId) {
		NSArray<NSNumber *> *origin = @[@0, @2, @14, @6, @17, @2, @60, @5, @12, @0, @22, @16, @60, @17, @6, @7, @40];
		NSData *data = [ExpandFamilyData ExpandFamilyDataToData:origin];
        StructExpandFamilyData value = (StructExpandFamilyData){99, (Byte *)data.bytes, 16, 89, 74};
        k_utilityId = [self StringFromExpandFamilyData:&value];
    }
    return k_utilityId;
}

//: key.Notification.Tap.To.Modify.Exposure.Point
+ (NSString *)app_dynamicsId {
    /* static */ NSString *app_dynamicsId = nil;
    if (!app_dynamicsId) {
		NSArray<NSNumber *> *origin = @[@31, @17, @13, @90, @58, @27, @0, @29, @18, @29, @23, @21, @0, @29, @27, @26, @90, @32, @21, @4, @90, @32, @27, @90, @57, @27, @16, @29, @18, @13, @90, @49, @12, @4, @27, @7, @1, @6, @17, @90, @36, @27, @29, @26, @0, @204];
		NSData *data = [ExpandFamilyData ExpandFamilyDataToData:origin];
        StructExpandFamilyData value = (StructExpandFamilyData){116, (Byte *)data.bytes, 45, 50, 246};
        app_dynamicsId = [self StringFromExpandFamilyData:&value];
    }
    return app_dynamicsId;
}

//: FaceActionEvent_Interval_12_frame
+ (NSString *)noti_stackKey {
    /* static */ NSString *noti_stackKey = nil;
    if (!noti_stackKey) {
		NSArray<NSNumber *> *origin = @[@34, @5, @7, @1, @37, @7, @16, @13, @11, @10, @33, @18, @1, @10, @16, @59, @45, @10, @16, @1, @22, @18, @5, @8, @59, @85, @86, @59, @2, @22, @5, @9, @1, @165];
		NSData *data = [ExpandFamilyData ExpandFamilyDataToData:origin];
        StructExpandFamilyData value = (StructExpandFamilyData){100, (Byte *)data.bytes, 33, 68, 40};
        noti_stackKey = [self StringFromExpandFamilyData:&value];
    }
    return noti_stackKey;
}
...
//
//#import "CommunicateMain.h"
//#import "RealmProgramReactiveCompatible.h"
//ST_MOBILE
...
@interface NetView ()<CorrectCord,UIGestureRecognizerDelegate>
{
...
//: @property (nonatomic, strong) RemainAccessLicHelper * lichelper;
@property (nonatomic, strong) RemainAccessLicHelper * lichelper;
//: @property (nonatomic, strong) SeekThen * ParamUtil;
@property (nonatomic, strong) SeekThen * ParamUtil;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        //: self.lichelper = [RemainAccessLicHelper share];
        self.lichelper = [RemainAccessLicHelper share];
        //: self.ParamUtil = [[SeekThen alloc]init];
        self.ParamUtil = [[SeekThen alloc]init];
        //: _currentDropCount = 5;
        ...
        if ([self.lichelper musculusAbductorPollicis]) {
            ...
            //: [[CommunicateMain share] getLocalModel];
            [[CommunicateMain share] rankSkin];
            ...
            [NSNotificationCenter.defaultCenter addObserver:self
                                                   ...
                                                   selector:@selector(hairses:)
                                                       //: name:@"key.Notification.Tap.To.Modify.Exposure.Point"
                                                       name:[ExpandFamilyData app_dynamicsId]
                                                     //: object:nil];
                                                     object:nil];
            ...
            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(instanceNotice:) name:self.ParamUtil.kNotificationSelectBeautyFilterStr object:nil];
            ...
            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(canvassed:) name:self.ParamUtil.kNotificationBeautyFilterValueChangeStr object:nil];
...
- (instancetype)initStop:(NSString*)sessionPreset {
    ...
    if (self = [super init]) {
        ...
        //: } else {
            ...
            //: [RemainAccessLicHelper.share checkRemoteLicInfoWithCompletion:^(BOOL x) {
            [RemainAccessLicHelper.share lengthWithCompletion:^(BOOL x) {
                //: if (x) {
                if (x) {
                    //: [self initFilterView:sessionPreset];
                    [self initFilterView:sessionPreset];
...
- (void)initFilterView:(NSString*)sessionPreset {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(instanceNotice:)
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(canvassed:)
...
- (void)situateFilter {
    ...
    //: if ([CommunicateMain share].filterSuite.filterModelPath.length > 0) {
    if ([CommunicateMain share].filterSuite.filterModelPath.length > 0) {
        //: RealmProgramReactiveCompatible* model = [[CommunicateMain share] getFilterDataModel];
        RealmProgramReactiveCompatible* model = [[CommunicateMain share] iconShare];
        //: if (model) {
        if (model) {
...
- (void)setCurrentSessionPreset:(NSString *)currentSessionPreset {
    ...
    [self.stCamera inAttitudeFrame:self.previewCenter from:self.previewFrame];
}
...
- (void)landholding {
    ...
    _stCamera = [[ProvinceSomebody alloc] initWithCaptureHair:AVCaptureDevicePositionFront
                                          //: sessionPresset:self.currentSessionPreset
                                          fromOnOutput:self.currentSessionPreset
                                                     //: fps:fps
                                                     object:fps
                                           //: needYuvOutput:NO];
                                           capacity:NO];
...
- (void)style:(CGFloat)width min:(CGFloat)height {
    //: CGRect previewRect = [self.stCamera getScaleRect:CGRectMake(0 , 0 , width, height)
    CGRect previewRect = [self.stCamera name:CGRectMake(0 , 0 , width, height)
                                                   //: scaleToFit:NO];
                                                   totalRelation:NO];
    ...
    if (self.glPreview.superview == nil) {
        ...
        @synchronized (self) {
           ...
           _glPreview = [[LessView alloc] initWithRenderReport:previewRect suite_strong:previewContext];
        }
...
- (void)point {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(clickSmooth) name:UIApplicationWillResignActiveNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appDidEnterBackground) name:UIApplicationDidEnterBackgroundNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(shrinkEnter) name:UIApplicationDidEnterBackgroundNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appWillEnterForeground) name:UIApplicationWillEnterForegroundNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(lengthWant) name:UIApplicationWillEnterForegroundNotification object:nil];

    //: [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(appDidBecomeActive) name:UIApplicationDidBecomeActiveNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(detailUp) name:UIApplicationDidBecomeActiveNotification object:nil];
}
...
- (void)device:(CMAccelerometerData *)accelerometerData {
...
- (st_rotate_type)attitude {
    ...
    [self device:self.motionManager.accelerometerData];
...
- (void)disappear {
    ...
    //初始化检测模块句柄
    //: NSString *strModelPath = [CurrencyDefineReactiveCompatible.getModelFileName stringByAppendingPathComponent:@"M_SenseME_Face_Video_5.3.4"];
    NSString *strModelPath = [CurrencyDefineReactiveCompatible.atCook stringByAppendingPathComponent:[ExpandFamilyData main_familyContent]];
    //: strModelPath = [strModelPath stringByAppendingPathExtension:@"model"];
    strModelPath = [strModelPath stringByAppendingPathExtension:[ExpandFamilyData noti_spillPath]];
...
- (void)initEffect {
    ...
    [self remoteDown:&_cvBeautifyBuffer
                                    //: w:self.imageWidth
                                    clearLine:self.imageWidth
                                    //: h:self.imageHeight
                                    textureImage:self.imageHeight
                            //: glTexture:&_textureBeautifyOutput
                            top:&_textureBeautifyOutput
                            //: cvTexture:&_cvTextureBeautify];
                            present:&_cvTextureBeautify];

    //: [self setupTextureWithPixelBuffer:&_cvStickerBuffer
    [self remoteDown:&_cvStickerBuffer
                                    //: w:self.imageWidth
                                    clearLine:self.imageWidth
                                    //: h:self.imageHeight
                                    textureImage:self.imageHeight
                            //: glTexture:&_textureStickerOutput
                            top:&_textureStickerOutput
                            //: cvTexture:&_cvTextureSticker];
                            present:&_cvTextureSticker];

    //: [self setupTextureWithPixelBuffer:&_cvFilterBuffer
    [self remoteDown:&_cvFilterBuffer
                                    //: w:self.imageWidth
                                    clearLine:self.imageWidth
                                    //: h:self.imageHeight
                                    textureImage:self.imageHeight
                            //: glTexture:&_textureFilterOutput
                            top:&_textureFilterOutput
                            //: cvTexture:&_cvTextureFilter];
                            present:&_cvTextureFilter];

    //: [self setupTextureWithPixelBuffer:&_cvMakeUpBuffer
    [self remoteDown:&_cvMakeUpBuffer
                                    //: w:self.imageWidth
                                    clearLine:self.imageWidth
                                    //: h:self.imageHeight
                                    textureImage:self.imageHeight
                            //: glTexture:&_textureMakeUpOutput
                            top:&_textureMakeUpOutput
                            //: cvTexture:&_cvTextureMakeup];
                            present:&_cvTextureMakeup];

}

//: - (BOOL)setupTextureWithPixelBuffer:(CVPixelBufferRef *)pixelBufferOut
- (BOOL)remoteDown:(CVPixelBufferRef *)pixelBufferOut
                                  //: w:(int)iWidth
                                  clearLine:(int)iWidth
                                  //: h:(int)iHeight
                                  textureImage:(int)iHeight
                          //: glTexture:(GLuint *)glTexture
                          top:(GLuint *)glTexture
                          //: cvTexture:(CVOpenGLESTextureRef *)cvTexture {
                          present:(CVOpenGLESTextureRef *)cvTexture {
...
- (BOOL)save:(CVPixelBufferRef)pixelBuffer {
...
- (void)hairses:(NSNotification *)sender {
    ...
    if ([tapGesture isKindOfClass:UITapGestureRecognizer.class]) {
        ...
        [self fromScreen:tapGesture];
    }

}

//: - (void)tapScreen:(UITapGestureRecognizer *)tapGesture {
- (void)fromScreen:(UITapGestureRecognizer *)tapGesture {
    ...
    [self.stCamera inAttitudeFrame:point from:self.frame];
...
- (UIImageView *)focusImageView {
    ...
    if (!_focusImageView) {
        ...
        _focusImageView.image = [UIImage imageNamed:[ExpandFamilyData k_utilityId]];
...
- (void)instanceNotice:(NSNotification*) notice {
    //: if ([notice.object isKindOfClass:[RealmProgramReactiveCompatible class]]) {
    if ([notice.object isKindOfClass:[RealmProgramReactiveCompatible class]]) {
        //: RealmProgramReactiveCompatible* model = (RealmProgramReactiveCompatible*)notice.object;
        RealmProgramReactiveCompatible* model = (RealmProgramReactiveCompatible*)notice.object;
        //: [self handleFilterChanged:model];
        [self page:model];
    }
...
//: - (void)handleFilterChanged:(RealmProgramReactiveCompatible *)model {
- (void)page:(RealmProgramReactiveCompatible *)model {
...
- (void)canvassed:(NSNotification*) notice {
    //: RealmProgramReactiveCompatible* model = (RealmProgramReactiveCompatible*)notice.object;
    RealmProgramReactiveCompatible* model = (RealmProgramReactiveCompatible*)notice.object;
    //: if (_hFilter) {
    if (_hFilter) {
...
- (void)beautyBlock {
    ...
    //: EntiretycostSeparateModelReactiveCompatible *beautyValueCache = CommunicateMain.share.currentBeautySuite;
    EntiretycostSeparateModelReactiveCompatible *beautyValueCache = CommunicateMain.share.glamorStyle;

    // 设置美白参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_WHITEN_STRENGTH value:beautyValueCache.fWhitenStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_WHITEN_STRENGTH value:beautyValueCache.fWhitenStrength];
    // 设置默认红润参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_REDDEN_STRENGTH value:beautyValueCache.fReddenStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_REDDEN_STRENGTH value:beautyValueCache.fReddenStrength];
    // 设置默认磨皮参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SMOOTH_STRENGTH value:beautyValueCache.fSmoothStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SMOOTH_STRENGTH value:beautyValueCache.fSmoothStrength];
    // 设置默认大眼参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ENLARGE_EYE_RATIO value:beautyValueCache.fEnlargeEyeStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ENLARGE_EYE_RATIO value:beautyValueCache.fEnlargeEyeStrength];
    // 设置默认瘦脸参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_FACE_RATIO value:beautyValueCache.fShrinkFaceStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_FACE_RATIO value:beautyValueCache.fShrinkFaceStrength];
    // 设置小脸参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_JAW_RATIO value:beautyValueCache.fShrinkJawStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_JAW_RATIO value:beautyValueCache.fShrinkJawStrength];

    //瘦脸型
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_THIN_FACE_SHAPE_RATIO value:beautyValueCache.fThinFaceShapeStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_THIN_FACE_SHAPE_RATIO value:beautyValueCache.fThinFaceShapeStrength];
    //窄脸
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_NARROW_FACE_STRENGTH value:beautyValueCache.fNarrowFaceStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_NARROW_FACE_STRENGTH value:beautyValueCache.fNarrowFaceStrength];
    //圆眼
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ROUND_EYE_RATIO value:beautyValueCache.fRoundEyeStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_ROUND_EYE_RATIO value:beautyValueCache.fRoundEyeStrength];
    //下巴
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_CHIN_LENGTH_RATIO value:beautyValueCache.fChinStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_CHIN_LENGTH_RATIO value:beautyValueCache.fChinStrength];
    //额头
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_HAIRLINE_HEIGHT_RATIO value:beautyValueCache.fHairLineStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_HAIRLINE_HEIGHT_RATIO value:beautyValueCache.fHairLineStrength];
    //瘦鼻翼
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NARROW_NOSE_RATIO value:beautyValueCache.fNarrowNoseStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NARROW_NOSE_RATIO value:beautyValueCache.fNarrowNoseStrength];
    //长鼻
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NOSE_LENGTH_RATIO value:beautyValueCache.fLongNoseStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_NOSE_LENGTH_RATIO value:beautyValueCache.fLongNoseStrength];
    //嘴形
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_MOUTH_SIZE_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fMouthStrength]];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_MOUTH_SIZE_RATIO value:[self burn:beautyValueCache.fMouthStrength]];
    //缩人中
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PHILTRUM_LENGTH_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fPhiltrumStrength]];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PHILTRUM_LENGTH_RATIO value:[self burn:beautyValueCache.fPhiltrumStrength]];

    //设置对比度参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_CONTRAST_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fContrastStrength]];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_CONTRAST_STRENGTH value:[self burn:beautyValueCache.fContrastStrength]];

    //设置饱和度参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SATURATION_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fSaturationStrength]];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SATURATION_STRENGTH value:[self burn:beautyValueCache.fSaturationStrength]];

    //锐化参数
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHARPEN_STRENGTH value:[self rangeMappedValueFrom:beautyValueCache.fSharpenStrength]];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHARPEN_STRENGTH value:[self burn:beautyValueCache.fSharpenStrength]];

    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_APPLE_MUSLE_RATIO value:[self rangeMappedValueFrom:beautyValueCache.fAppleMusleStrength]];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_APPLE_MUSLE_RATIO value:[self burn:beautyValueCache.fAppleMusleStrength]];

    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PROFILE_RHINOPLASTY_RATIO value:beautyValueCache.fProfileRhinoplastyStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_PROFILE_RHINOPLASTY_RATIO value:beautyValueCache.fProfileRhinoplastyStrength];

    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_DISTANCE_RATIO value:beautyValueCache.fEyeDistanceStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_DISTANCE_RATIO value:beautyValueCache.fEyeDistanceStrength];

    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_ANGLE_RATIO value:beautyValueCache.fEyeAngleStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_EYE_ANGLE_RATIO value:beautyValueCache.fEyeAngleStrength];

    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_OPEN_CANTHUS_RATIO value:beautyValueCache.fOpenCanthusStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_OPEN_CANTHUS_RATIO value:beautyValueCache.fOpenCanthusStrength];

    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_BRIGHT_EYE_RATIO value:beautyValueCache.fBrightEyeStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_BRIGHT_EYE_RATIO value:beautyValueCache.fBrightEyeStrength];
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_DARK_CIRCLES_RATIO value:beautyValueCache.fRemoveDarkCirclesStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_DARK_CIRCLES_RATIO value:beautyValueCache.fRemoveDarkCirclesStrength];
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_NASOLABIAL_FOLDS_RATIO value:beautyValueCache.fRemoveNasolabialFoldsStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_REMOVE_NASOLABIAL_FOLDS_RATIO value:beautyValueCache.fRemoveNasolabialFoldsStrength];
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_WHITE_TEETH_RATIO value:beautyValueCache.fWhiteTeethStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_3D_WHITE_TEETH_RATIO value:beautyValueCache.fWhiteTeethStrength];
    //: [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_CHEEKBONE_RATIO value:beautyValueCache.fShrinkCheekboneStrength];
    [self.ParamUtil containAccelerateWithBeautifyHandle:_hBeautify type:ST_BEAUTIFY_SHRINK_CHEEKBONE_RATIO value:beautyValueCache.fShrinkCheekboneStrength];

}

//: - (float)rangeMappedValueFrom:(float) rawValue {
- (float)burn:(float) rawValue {
...
void cellDirection(st_mobile_animal_face_t *src, int faceCount, st_mobile_animal_face_t *dst) {
...
void diagnosticProcedure(st_mobile_animal_face_t *src, int faceCount) {
    //: if (faceCount > 0) {
    if (faceCount > 0) {
        //: for (int i = 0; i < faceCount; ++i) {
        for (int i = 0; i < faceCount; ++i) {
...
- (void)without:(CMSampleBufferRef)originalSampleBuffer
                       //: resultPixelBuffer:(CVPixelBufferRef)resultPixelBufffer {
                       push:(CVPixelBufferRef)resultPixelBufffer {
    ...
    if ( originalSampleBuffer && resultPixelBufffer ) {
        ...
        if (tmpDelegate && [tmpDelegate respondsToSelector:@selector(sampleFrameBuffer:fill:)]) {
            ...
            if (sampleBuffer) {
                ...
                [tmpDelegate sampleFrameBuffer:self fill:sampleBuffer];
            }
...
- (CVPixelBufferRef)bury:(CVPixelBufferRef)pixelBuffer {
...
- (void)rate:(AVCaptureOutput *)captureOutput start:(CMSampleBufferRef)sampleBuffer postConnexion:(AVCaptureConnection *)connection {
    ...
    st_rotate_type stMobileRotate = [self attitude];
    ...
    if (_hDetector) {
        ...
        if (self.iCurrentAction > 0) {
            ...
            if (_faceFrameCount == 12) { // 第12帧时
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:[ExpandFamilyData noti_stackKey] object:nil userInfo: @{[ExpandFamilyData app_symbolShouldUrl]: @(hasFace)}];
            }
            ...
            if (_faceFrameCount%18 == 0) { // 每秒发送一次
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:[ExpandFamilyData main_judgeBroadUrl] object:nil userInfo: @{[ExpandFamilyData app_symbolShouldUrl]: @(hasFace)}];
            }
        }
    }
    ...
    if (faceCount > 0) {
        ...
        cellDirection(_detectResult1, faceCount, newDetectResult1);
    }
    ...
    dispatch_async(self.renderQueue, ^{
       ...
       BOOL isTextureOriginReady = [self save:pixelBuffer];
       ...
       // ST_MOBILE 以下为滤镜部分
        ...
        if (callBackFlag) [self without:sampleBuffer push:resultPixelBufffer];
        ...
        if (faceCount > 0) {
            ...
            diagnosticProcedure(newDetectResult1, faceCount);
        }
        //: if (callBackFlag) {
        if (callBackFlag) {
            //: @synchronized (self) {
            @synchronized (self) {
                ...
                [self.glPreview quote:textureResult];
            }
        }
