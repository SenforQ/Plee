...
// __CLOSE_PRINT__
//
//  RepresentLanguageManager.swift
//  Adjust
//
...
@objcMembers open class RepresentLanguageManager: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = RepresentLanguageManager()
    //: private(set) var currLanguage: String = CurrencyDefineReactiveCompatible.getSystemLangCode()
    private(set) var currLanguage: String = CurrencyDefineReactiveCompatible.afterPinChild()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func province(_ language: String) {
...
extension String {
    ...
    public func restateArguments(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = PortraitJackEffectTool.default.languagePath
