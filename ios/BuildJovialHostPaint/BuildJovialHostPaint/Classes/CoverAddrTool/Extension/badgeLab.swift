...
class EndRunReactiveCompatible: UILabel {
    ...
    private func house() {
        ...
        layer.backgroundColor = UIColor.foursquare().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.shrinkSize(type: .Medium, fontSize: 11)
...
class RoundReactiveCompatible: UILabel {
