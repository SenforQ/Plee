...
enum GreatSubqueryConvertible: String {
    //: case AppleLogin
...
enum RestrictionMeasurable: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
enum CommentEntryStarStatus: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum CapabilityBinaryCounterval: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum GraphHashableRepresentation: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum WidespreadSignedQuantity: Int {
    //: case Unavailable = 0
...
enum UserCaseIterable: CaseIterable {
