...
/*: "&sr=6" :*/
fileprivate let appRemindName:String = "queen register automatic submit label&sr=6"
...
enum LimitedTransformable: String, CaseIterable {
...
enum ObjectDefaultsSerializable: String {
...
class LimitedManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func ethmoidalArteryMobile(urlType: ObjectDefaultsSerializable) -> String {
        //: var url = RealmReactiveCompatible.share.appConfigMode.urlH5Domain
        var url = RealmReactiveCompatible.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(RealmReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : RealmReactiveCompatible.share.appUserConfigMode.fullRechargePage)
            url.append(RealmReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : RealmReactiveCompatible.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage)
            url.append(RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending((String(appRemindName.suffix(5))))
            //: url.append(RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(RealmReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
